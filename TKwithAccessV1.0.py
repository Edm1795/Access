...
# Version 1.0
# This is the first version with an interface. It loads an interface which can easily have extra buttons added below.
# Each button in turn loads a different MsAccess file which runs a specific automation by calling the main() of that file
...
class MainWindow:
    ...
    def __init__(self, master,winPosHorVer,winSizeHorVert,mainFrameCol,lineColour,lineWidth,breadth,position,week,computer,pixelsPerMinute,eightAMline):
        ...
        # Master Window
        self.master = master
        self.master.title('Run Access Databases')
        ...
        self.button = Button(self.frame1, text="Access", width=12, command=lambda : self.runAccess())
        self.button.pack()
        #
